...
<td class='product-name wpsc_product_name'><a href="<?php echo wpsc_cart_item_url(); ?>"><?php echo wpsc_cart_item_name(); ?></a></td>
...
?></div>
<script type="text/javascript">progo_checkcart();</script>